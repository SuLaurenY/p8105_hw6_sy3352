...
From the cross validation result, we can see that the interaction model is more accurate in predicting birth weight (mean rmse = 289). This means that we should consider head circumference, length, baby sex and their interactions when building models for prediction.